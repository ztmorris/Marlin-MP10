...
#define STRING_CONFIG_H_AUTHOR "(Zac)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Work Horse"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "058fa1c4-cf92-4360-a634-d161708a288f"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    //#define DEFAULT_Kp_LIST {  22.20,  22.20 } //Original
...
// This will remove the need to poll the interrupt pins, saving many CPU cycles.mp10 
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 200, 100 } // was 100, 100, 400, 500
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 10, 50 }// old values { 300, 300, 5, 25 }
...
#define INVERT_E0_DIR true // Checks good for MP10
...
#define PREHEAT_2_TEMP_HOTEND 259
 ...
 *   root of your SD card, together with the cosssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssmpiled firmware.
 */
